...
public class OperationalDataAdminController {
 ...
 private void applyAppliedSchedule(TbRegBuy x,RegularBuyRequest b){x.setLegacyCycleType(b.appliedCycle());x.setLegacyWeekDays(b.appliedCycle().equals("WEEKLY")?b.appliedWeekDays():null);x.setLegacyMonthDay(b.appliedCycle().equals("MONTHLY")?b.appliedMonthDay():null);}
