...
public class OperationalDataAdminController {
 ...
 private List<Map<String,Object>> regularBuyRows(){return jdbc.sql("""
  SELECT r."ACCT_TP"||'/'||r."STK_CD" AS "regularBuyKey",
   ...
   r."BUY_BASIS" AS "buyBasis",COALESCE(r."BASE_AMT",r."BASE_BUY_AMT",r."MIN_BUY_AMT") AS "baseAmount",
   r."BASE_QTY" AS "baseQuantity",r."BASE_PAUSE_RSN" AS "basePauseReason",r."ACTV_YN" AS "activeYn",
   ...
   COALESCE(r."AMT",r."RCMD_BUY_AMT",r."MIN_BUY_AMT") AS "appliedAmount",COALESCE(r."QTY",r."BASE_QTY") AS "appliedQuantity",
   ...
   r."USER_PAUSE_YN" AS "userPauseYn",r."AUTO_CALC_YN" AS "autoCalculateYn",r."USE_YN" AS "useYn"
  FROM "TB_REG_BUY" r
