...
public record StockAnalysisInput(
        String accountType, String stockCode, String stockName,
        BigDecimal quantity, BigDecimal avgPrice, BigDecimal currentPrice,
        ...
        boolean aboveMa5, boolean aboveMa20, boolean benchmarkStable,
        boolean existingRiskResolved, boolean rebuyEligible
) {
}
