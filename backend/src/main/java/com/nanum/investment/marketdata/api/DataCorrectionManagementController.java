...
public class DataCorrectionManagementController {
  ...
  public DataCorrectionManagementController(DataCorrectionManagementService service) {
  ...
  public List<Map<String, Object>> recalculations(
      @RequestParam(defaultValue = "PENDING") String status,
      @RequestParam(defaultValue = "100") int limit) {
    return service.recalculations(status, limit);
  }
