...
public class BriefingRefreshService {
 ...
 private final AutomaticInvestmentDecisionService decisions;private final DailyBuyPlanService plans;private final AutomaticRebalanceService rebalancing;private final BriefingRawDataService rawData;private final InvestmentBriefingService briefing;
 public BriefingRefreshService(HoldingMarketDataRefreshService holdings,ExchangeRateService exchange,FredBondYieldService bonds,
  ...
  AutomaticInvestmentDecisionService decisions,DailyBuyPlanService plans,AutomaticRebalanceService rebalancing,BriefingRawDataService rawData,InvestmentBriefingService briefing){this.holdings=holdings;this.exchange=exchange;this.bonds=bonds;this.validation=validation;this.snapshots=snapshots;this.sentiments=sentiments;this.decisions=decisions;this.plans=plans;this.rebalancing=rebalancing;this.rawData=rawData;this.briefing=briefing;}
 ...
 public BriefingRefreshResult refresh(){
  ...
  if(raw)attempt("11-13 OpenAI 설명·검증·발행",completed,failures,results,briefing::generateAndSave);
