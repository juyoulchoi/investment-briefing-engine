...
public class TbPrcDay {
  ...
  @Column(name = "HIGH_PRC", precision = 20, scale = 6)
  private BigDecimal highPrice;

  @Column(name = "LOW_PRC", precision = 20, scale = 6)
  private BigDecimal lowPrice;

  @Column(name = "CLS_PRC", nullable = false, precision = 20, scale = 6)
  private BigDecimal closePrice;

  @Column(name = "ADJ_CLS_PRC", precision = 20, scale = 6)
