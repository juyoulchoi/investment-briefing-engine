...
public record StockPosition(
 ...
 public boolean isOverweight(){ return targetWeight>0 && currentWeight>targetWeight*1.20; }
 public long effectiveMaximumBuyAmount(double m){ return maximumBuyAmount>0?maximumBuyAmount:Math.round(minimumBuyAmount*m); }
}
