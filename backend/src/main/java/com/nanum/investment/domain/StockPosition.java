...
public record StockPosition(
    ...
    public StockPosition(String account, String code, String name, long minimumBuyAmount, long maximumBuyAmount,
            double profitLossPct, double stockDrawdownPct, double targetWeight, double currentWeight,
            double fundamentalScore, double valuationScore, double themeRiskScore, boolean regularBuyEnabled) {
        this(account, code, name, minimumBuyAmount, maximumBuyAmount, 3.0, profitLossPct, stockDrawdownPct,
                targetWeight, currentWeight, fundamentalScore, valuationScore, themeRiskScore, regularBuyEnabled);
    }
    ...
    public long effectiveMaximumBuyAmount() {
        return maximumBuyAmount > 0 ? maximumBuyAmount
