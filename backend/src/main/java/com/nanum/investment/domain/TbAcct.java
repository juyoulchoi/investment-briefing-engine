...
public class TbAcct {
 ...
 @Builder.Default @Column(name="BASE_CURR_CD",nullable=false,length=10) private String baseCurrencyCode="KRW";
 @Builder.Default @Column(name="CASH_AMT",nullable=false,precision=20,scale=4) private BigDecimal cashAmount=BigDecimal.ZERO;
 @Builder.Default @Column(name="RSV_CASH_AMT",nullable=false,precision=20,scale=4) private BigDecimal reservedCashAmount=BigDecimal.ZERO;
 @Column(name="TGT_CASH_WGT",precision=7,scale=4) private BigDecimal targetCashWeight;
 @Builder.Default @Column(name="DISP_SEQ",nullable=false) private Integer displaySequence=0;
