...
@Table(
    ...
    uniqueConstraints =
        @UniqueConstraint(
            name = "UK_TB_EXCH_DAY_01",
            columnNames = {"BASE_DT", "BASE_CURR_CD", "QUOTE_CURR_CD"}))
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class TbExchDay {
  @Id
  @GeneratedValue(strategy = GenerationType.IDENTITY)
  @Column(name = "EXCH_DAY_ID")
  ...
  @Column(name = "QUOTE_CURR_CD", nullable = false, length = 10)
  private String quoteCurrencyCode;

  @Column(name = "EXCH_RT", nullable = false, precision = 20, scale = 6)
  private BigDecimal exchangeRate;

  @Column(name = "PREV_EXCH_RT", precision = 20, scale = 6)
