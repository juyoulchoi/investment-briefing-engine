...
public class TbApiLog {
  ...
  @Column(name = "API_GRP_CD", nullable = false, length = 30)
  private String apiGroupCode;

  @Column(name = "API_NM", nullable = false, length = 150)
  private String apiName;

  @Column(name = "HTTP_METHOD", length = 10)
  private String httpMethod;

  @Column(name = "REQ_URL", length = 2000)
  ...
  @Column(name = "HTTP_STS_CD")
  private Integer httpStatusCode;

  @Column(name = "RSP_BODY", columnDefinition = "TEXT")
