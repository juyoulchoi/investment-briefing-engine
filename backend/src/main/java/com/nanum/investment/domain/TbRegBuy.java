...
public class TbRegBuy {
 ...
 @Column(name="STK_NM",nullable=false) private String legacyStockName; @Column(name="CYCLE_TP",nullable=false) private String legacyCycleType; @Column(name="WEEK_DAY") private String legacyWeekDays; @Column(name="MONTH_DAY") private Integer legacyMonthDay; @Builder.Default @Column(name="ACTV_YN",nullable=false,length=1) private String legacyActiveYn="Y";
