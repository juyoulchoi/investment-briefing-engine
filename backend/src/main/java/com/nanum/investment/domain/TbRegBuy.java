...
public class TbRegBuy {
 ...
 @Builder.Default @Column(name="MAX_MULT",nullable=false,precision=8,scale=4) private BigDecimal maximumMultiplier=new BigDecimal("3"); @Column(name="MKT_MULT",precision=8,scale=4) private BigDecimal marketMultiplier;
