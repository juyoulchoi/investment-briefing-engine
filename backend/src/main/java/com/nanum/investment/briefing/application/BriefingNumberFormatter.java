...
public class BriefingNumberFormatter {
  public String integer(Number value) {
    return grouped(value.longValue());
  }

  public String score(Number value) {
    return integer(value) + "점";
  }
  ...
  public String exchangeRate(Number value) {
    return grouped(Math.round(value.doubleValue())) + "원";
  }
