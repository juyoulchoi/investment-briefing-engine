...
class MarketDirectionPredictionServiceTest {
  @Test
  void normalizedProbabilitiesAlwaysSumToOneHundred() {
  ...
  @Test
  void rejectsScenarioProbabilityWhenSumIsNotOneHundred() {
    assertThatThrownBy(
            () ->
                MarketDirectionPredictionService.validate(
                    new MarketScenarioProbabilityDto(25, 40, 25, 11, 0, 0, 0, 0)))
        .isInstanceOf(IllegalStateException.class)
        .hasMessageContaining("합계가 100");
  }
}
