...
type Page="dashboard"|"briefing"|"holdings"|"regular"|"additional"|"rebalance"|"history"|"reference"|"operations"|"marketadmin"|"bondyields";
const nav:[Page,string,string][]=[["dashboard","대시보드","⌂"],["briefing","투자 브리핑","▤"],["holdings","보유종목","◇"],["regular","정기매수","↻"],["additional","추가매수","+"],["rebalance","리밸런싱","⇄"],["history","브리핑 이력","◷"],["reference","기준정보 관리","⚙"],["operations","투자 설정 관리","⌘"],["marketadmin","시장 분석 관리","◉"],["bondyields","FRED 채권금리","％"]];
