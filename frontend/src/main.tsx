...
function Holdings(){
 ...
 const isOverseas=selected==="OVERSEAS",holdingEvaluation=(h:Holding)=>isOverseas?Number(h.currentPrice||0)*Number(h.holdingQuantity||0):Number(h.evaluationAmount||0),formatMoney=(n:number)=>amount(n,isOverseas);
